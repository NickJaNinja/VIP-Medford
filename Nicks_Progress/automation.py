    ...
    for i in pw_range:
        ...
        for j in k_range:
            ...
            for k in ['co', 'slab', 'comb']:
                ...
                python_command = base_python_command.format(LOCATION = base_location, TYPE = k, PW = i, KPT = j)
    ...
    for i in pw_range:
        ...
        for j in k_range:
            ...
            for k in ['co', 'slab', 'comb']:
                ...
                if not os.path.isfile(result_file_name) and os.path.isfile('stdout') and submissions < max_submissions:
                    os.remove('stdout')
